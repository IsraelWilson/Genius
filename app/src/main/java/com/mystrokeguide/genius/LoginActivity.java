...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check if the user is logged in. If they are then start the Game Activity
        session.checkLogin();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        private static final String login = "http://youngstroke.com/Genius/login.php";
        ...
        protected String doInBackground(Void... params) {
            ...
            args.add(new BasicNameValuePair("email", mEmail));
        ...
        protected void onPostExecute(final String message) {
            ...
            if(message.equals("User found")){
                Toast.makeText(ctx, "User found", Toast.LENGTH_SHORT);
                startActivity(new Intent(ctx, GameActivity.class));
                finish();

            }
            else if(message.equals("User not found")){
                Toast.makeText(ctx, "New User created", Toast.LENGTH_SHORT);
                startActivity(new Intent(ctx, ShortProfileActivity.class));
                finish();

            }
            else if(message.equals("JSON Exception")){
